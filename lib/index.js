...
function createToolDefs(api, ctx = null) {
  ...
  const emuUi = {
    ...
    async execute(args, exec) {
      ...
      const dumpLayout = async (full = false, atDepth = depth) => {
      ...
      const perform = async (a) => {
        ...
        if (action === "layout") {
          ...
          const note = textless ? `\u8FD9\u6B21 dump \u53EA\u6709\u5BB9\u5668\u3001\u6CA1\u6709\u4EFB\u4F55\u6587\u5B57:depth=${at} \u53EA\u5230\u7B2C ${at} \u5C42${a?.full === true ? "(full \u6A21\u5F0F\u8FD8\u4F1A\u591A\u51FA window/root \u4E24\u5C42)" : ""};\u8981\u770B\u5185\u5BB9\u8BF7\u7528 depth:0 \u6216\u4E0D\u4F20 depth\u3002` : void 0;
