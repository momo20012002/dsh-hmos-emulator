...
${v.output}`);
  ...
  if (shot) nodes.push(h(
    Card,
    {
      ...
      title: "\u6700\u8FD1\u622A\u56FE",
      style: { marginTop: 12 },
      action: h(Btn, { ghost: true, style: { padding: "0 6px", fontSize: 14, lineHeight: 1 }, onClick: () => setShot(null), title: "\u5173\u95ED" }, "\xD7")
    },
    h(
      "div",
      {
      ...
      shot.dataUrl ? h("img", { src: shot.dataUrl, style: { maxWidth: "100%", maxHeight: 240, objectFit: "contain", borderRadius: 6, display: "block" } }) : h("div", { style: { fontSize: 11, color: s.faint, padding: "18px 0" } }, "(\u9884\u89C8\u4E0D\u53EF\u7528,\u6587\u4EF6\u5DF2\u4FDD\u5B58)")
    ),
    h(
      "div",
